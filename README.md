I was successfully able to create and simulate a multistage amplifer using MULTISIM. In this case it is a two-stage (CE-CC) BJT amplifier. All requirements were met which included:
